...
try {
    ...
    if ($approved_only === '1') {
        ...
        $stmt = $pdo->query("SELECT id, name, category, price, description, `condition`, image1, image2, image3, image4, image5, image6, seller_email, seller_name, approved, admin_note, created_at FROM products ORDER BY created_at DESC");
    }
